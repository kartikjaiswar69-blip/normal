...
recognition.onresult = function(event) {
    ...
    if (command.includes("youtube")) {
        ...
        window.location.href = "Tools/Expense.html"; 
    ...
    }else if (command.includes("driving license") || command.includes("drivinglicense") || command.includes("parivahan")) {
    ...
    }else if (command.includes("a i video") || command.includes("videomaker") || command.includes("video maker")) {
